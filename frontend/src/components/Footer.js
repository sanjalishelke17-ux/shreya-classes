        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-8 h-8 rounded-lg bg-navy-800 hover:bg-gold-500 hover:text-navy-900 flex items-center justify-center transition-all"
              >
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href={`tel:${settings.phone}`} className="flex gap-3 hover:text-gold-400 transition-colors">
                <Phone className="w-4 h-4 text-gold-400 mt-0.5 flex-shrink-0" />
                <p className="text-sm">
                  {settings.phone ? `+91 ${settings.phone}` : 'Loading...'}
                </p>
              </a>
              <a href={`https://wa.me/91${settings.whatsapp}`} className="flex gap-3 hover:text-gold-400 transition-colors">
                ...
                <p className="text-sm">
                  {settings.whatsapp || 'WhatsApp Us'}
                </p>
              </a>
              <a href={`mailto:${settings.email}`} className="flex gap-3 hover:text-gold-400 transition-colors">
