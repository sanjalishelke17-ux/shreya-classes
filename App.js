...
const WithNav = ({ children }) => (
  <><Navbar />{children}<Footer /><WhatsAppButton /></>
);
    ...
    <AuthProvider>
      <Router>
        ...
        <Toaster position="top-right" toastOptions={{
          style: { background: '#0b1e3a', color: '#fff', borderRadius: '10px' },
          success: { iconTheme: { primary: '#e8b02a', secondary: '#0b1e3a' } },
        }} />
        <Routes>
          {/* Public pages */}
          ...
          <Route path="/portal/notes" element={<ProtectedRoute><StudentNotes /></ProtectedRoute>} />
          <Route path="/portal/announcements" element={<ProtectedRoute><StudentAnnouncements /></ProtectedRoute>} />
          <Route path="/portal/profile" element={<ProtectedRoute><StudentProfile /></ProtectedRoute>} />
          <Route path="/portal/fees" element={<ProtectedRoute><StudentFees /></ProtectedRoute>} />
